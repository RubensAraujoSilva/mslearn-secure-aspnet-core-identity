...
namespace RazorPagesPizza.Areas.Identity.Pages.Account
{
	public class RegisterModel : PageModel
	{
		...
		public class InputModel
		{
			...
			[Required]
			[StringLength(100, ErrorMessage = "O {0} precisa estar entre {2} e {1} caracteres.", MinimumLength = 1)]
			[Display(Name = "Nome")]
			...
			[Required (ErrorMessage = "Informe o cógido da loja")]
			...
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					...
					await _emailSender.SendEmailAsync(Input.Email, "Confirme seu e-mail",
							$"Por favor, confirme sua conta acessando a seguinte URL:\r\n\r\n{callbackUrl}");
